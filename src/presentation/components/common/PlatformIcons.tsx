...
export function PlatformIcon({ platform, size = 16, className }: { platform: Platform } & IconProps) {
  switch (platform) {
...
export const PLATFORM_META: Record<Platform, { label: string; color: string }> = {
  [Platform.TWITTER]: { label: 'X (Twitter)', color: 'twitter' },
  [Platform.LINKEDIN]: { label: 'LinkedIn', color: 'linkedin' },
  [Platform.FACEBOOK]: { label: 'Facebook', color: 'facebook' },
};
